      ...
      <ul class="menu_bar_right grid__item wide--one-sixth">        
        ...
        <li>
          <ul class="top_bar_right">
            ...
            <li><i class='fa fa-envelope' aria-hidden='true'></i> Mail <a href="mailto:tunitaste123@gmail.com"> tunitaste123@gmail.com</a></li>
...
if ($(window).width() < 1200) {
  ...
  <div class="h1 site-header__logo order-header  post-large--hide large--hide medium-down--hide" itemscope itemtype="http://schema.org/Organization">
    ...
    <a href="../view/index.php" itemprop="url">
      <img class="normal-logo" src="../view/assets/tuni.png" alt="Yummi-theme" itemprop="logo">
    </a>
...
<ul class="site-nav checking">   
    ...
    <li class="menu-lv-1 item dropdown mega-menu">
        <a class="menu__moblie "  href="../View/collections/all.php">
            Products
...
<div class="row">
    ...
    <li class="menu-lv-1 item dropdown mega-menu">
        <a class="menu__moblie "  href="../view/collections/fournisseur.php">
            Les restaurants
            ...
            <li class="customer_account"> 
              <div class="header-account_links">
                <ul> 
                  ...
                  <li>
                    <a href="../view/logout.php" title="Log in" data-value="value 1"><i class="fa fa-user post-large--hide large--hide medium-down--hide"></i><span class="wide--hide">Log out</span></a>
                  </li>
  ...
  <div class="header-mb-middle header-mb-items">
    <div class="header-logo">
        ...
        <div class="h1 site-header__logo" itemscope itemtype="http://schema.org/Organization">
          ...
          <a  href="../view/index.php" style="max-width: px;">
            <img class="normal-logo" src="../view/assets/tuni.png" alt="Yummi-theme" itemprop="logo">
          </a>
              ...
              <div class="header-panel-top">
                <div class="customer_account">                          
                  <ul>
                    ...
                    <li>
                      <a href="../view/logout.php" title="Log in"> <i class="fa fa-sign-in-alt icons" aria-hidden="true"></i> Log out</a>
                    </li>
                    <li>
                      <a href="../view/account/modif_profil.php" title="Create account">  <i class="fas fa-user" aria-hidden="true"></i> Settings</a>
                    </li>          
