...
<body>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children active dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="ajouter_fournisseur.php">Ajouter fournisseur</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="afficher_fournisseur.php">afficher_fournisseur</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon ti-themify-logo"></i><a href="afficher_reservation.php">Afficher reservation</a></li>
                        </ul>
                    </li>
                    <li>
    ...
    <input class="form-control mr-sm-2" type="text" placeholder="Search" name="search" id="search_text">
		...
		<table id="tab_fournisseur" class="table" border=1 align = 'center'>
