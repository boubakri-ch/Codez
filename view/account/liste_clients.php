...
<td>
<a class="supprimer" href="pdf.php">PDF</a>
<a class="supprimer" href="excel_client.php">EXCEL</a>
</td>	
<div class="content">
        <form enctype="multipart/form-data">
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    <input class="form-control mr-sm-2" type="text" placeholder="Search" name="search" id="ridha">
</nav>
<style>
table {
		...
		<table  border=1 align = 'center'  id="tab_client" >
			...
			?>
				<tr>
					...
					<td>
					 <a class="supprimer" href="supprim_client.php?id=<?PHP echo $client['code_client'];?>">Supprimer</a>
					 <a class="modifier" href="modif_client.php?id_modif=<?PHP echo $client['code_client'];?>">Modifier</a>
					</td>	
				</tr>
				</tr>
			<?PHP
