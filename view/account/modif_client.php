...
?>
<form class="form-box" id="create_customer" method="POST" action="validmodifer_client.php" enctype="multipart/form-data">
...
<div  data-errormsg="">
    <input type="text" name="nom" id="FirstName" value="<?php echo $row['nom']; ?>"  tabindex="2" />
</div>
<div  data-errormsg="">
    <input type="text" name="prenom" id="LastName" value="<?php echo $row['prenom']; ?>"  tabindex="3" />    
</div>

<div  data-errormsg="">
    <input type="text" name="email" id="Email" value="<?php echo $row['email']; ?>"  tabindex="4" />    
</div>  
<div  data-errormsg="">
    <input type="text" name="password" id="CreatePassword" value="<?php echo $row['password_c']; ?>" tabindex="5" />    
</div>
