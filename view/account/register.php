...
<input type="text" name="nom" id="FirstName" placeholder="First Name"  autocapitalize="words" autofocus>
</div>
<div data-errormsg="">

<label for="LastName" class="label--hidden">Last Name</label>
<input type="text" name="prenom" id="LastName" placeholder="Last Name"  autocapitalize="words">
</div>
<div data-errormsg="">
...
<input type="password" name="password" id="CreatePassword" placeholder="Password" >
      ...
      <button class="btn"id="button-cancel-prod">Annuler</button>
