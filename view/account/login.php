<?php   
  session_start();
   ...
   require "C:/wamp64/www/web/core/connexionOps.php";
   ...
   if (isset($_POST['email'])){
    ...
    $message=$p->connexion_admin($_POST["email"]);
    $message_1=$p->connexion_client($_POST["email"]);
    if($message != NULL){
    foreach ($message as $c ){
      if($_POST['password']=== $c['password_a'])
      {
          $_SESSION['id'] = $c['code_admin'];
          header ("location:liste_admin.php");
      }
    }
    }
    else{
      foreach ($message_1 as $d ){
        
        if($_POST['password']=== $d['password_c'])
        {
            $_SESSION['id'] = $d['code_client'];
            
            header ("location:C:/wamp64/www/web/view/liste_client.php");
        }
    }
...
<!-- Mirrored from yummi-theme.myshopify.com/account/login by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Apr 2021 14:12:54 GMT -->
...
<script id="__st">var __st={"a":26759790615,"offset":-14400,"reqid":"a61af705-77ab-414a-9a3d-8ec7d8362b6b","pageurl":"yummi-theme.myshopify.com\/account\/login","u":"f4bd72da5ef1"};</script>
<script>window.ShopifyPaypalV4VisibilityTracking = true;</script>
<script>window.ShopifyAnalytics = window.ShopifyAnalytics || {};
window.ShopifyAnalytics.meta = window.ShopifyAnalytics.meta || {};
window.ShopifyAnalytics.meta.currency = 'INR';
var meta = {"page":{},"page_view_event_id":"045b21dab6f6b7f8c0a1662f59a7b8f26a8047b6265ec642fa9ecce146d9d75a","cart_event_id":"b2c3d50ba4e9f348cbdf879e41a3faaef8ad61b547089af18ff990fc3e55bdf8"};
    ...
    document.write = originalDocumentWrite;
      (function () {
        ...
        window.ShopifyAnalytics.lib.page(
          null,
          {},
          "045b21dab6f6b7f8c0a1662f59a7b8f26a8047b6265ec642fa9ecce146d9d75a"
        );
...
<body id="account" class="template-customers-login  others ">
 ...
 <div class="container-bg"> 
  ...
  <div class="grid__item text-center">
    ...
    <div id="CustomerLoginForm">
      ...
      <button class="btn"id="button-cancel">Annuler</button>
      </form>
    ...
    <div id="RecoverPasswordForm" style="display: none;">
      ...
      <form method="post" action="https://yummi-theme.myshopify.com/account/recover" accept-charset="UTF-8"><input type="hidden" name="form_type" value="recover_customer_password" /><input type="hidden" name="utf8" value="✓" />
...
<!-- Mirrored from yummi-theme.myshopify.com/account/login by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Apr 2021 14:12:57 GMT -->
</html>