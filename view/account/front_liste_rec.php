...
<td>
        <a class="Excel" href="excel_front.php">EXCEL</a>
        <a class="Excel" href="pdf_front.php">PDF</a>
        </td>
        <div class="content">
		...
		<table  border=1 align = 'center' id=tab_rec >
			...
			?>
				<tr>
					...
					<td>
					<a href="supprim_rec.php?id=<?PHP echo $reclamation['code_rec'];?>">Supprimer</a>
                    <a class="modidfier" href="modif_rec.php?id_modif=<?PHP echo $reclamation['code_rec'];?>">Modifier</a>
					</td>	
				</tr>
			<?PHP
				}
