...
?>
<form class="form-box" id="create_customer" method="POST" action="validmodifier_rec.php" enctype="multipart/form-data">
...
<div  data-errormsg="">
    <input type="text" name="descrip" id="Descrip" value="<?php echo $row['descrip']; ?>"  tabindex="2" />
</div>
