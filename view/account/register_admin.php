<?php   
   ...
   if (isset($_POST['nom']))
    ...
    $p=new admin (NULL,$_POST['nom'],$_POST['prenom'],$_POST['email'],$_POST['password'],$_POST['role']);
    
    //var_dump($c);
    $admin = new adminOps();
    $admin->ajouterAdmin($p);

    echo "<p>admin ajouter avec succes</p>";
              ...
              <div class="header-panel-top">
                <div class="customer_account">                          
                  <ul>
                    ...
                    <li>
                      <a href="register_admin.php" title="Create account">  <i class="fas fa-user" aria-hidden="true"></i> Create account</a>
                    </li>          
...
<form method="post" action="" id="customer_login" accept-charset="UTF-8"><input type="hidden" name="form_type" value="create_customer" /><input type="hidden" name="utf8" value="✓" />

      
        <div data-errormsg="">

<label for="input-nom" class="label--hidden">First Name</label>
<input type="text" name="nom" id="input-nom" placeholder="First Name"  autocapitalize="words" autofocus>
</div>
<div data-errormsg="">

<label for="input-prenom" class="label--hidden">Last Name</label>
<input type="text" name="prenom" id="input-prenom" placeholder="Last Name"  autocapitalize="words">
</div>
<div data-errormsg="">

<label for="input-email" class="label--hidden">Email</label>
<input type="email" name="email" id="input-email" placeholder="Email"  autocorrect="off" autocapitalize="off">

</div>
<div data-errormsg="">

<label for="input-password" class="label--hidden">Password</label>
<input type="password" name="password" id="input-password" placeholder="Password" autocapitalize="words" autofocus>
</div>

</div>
<div data-errormsg="">

<label for="input-role" class="label--hidden">Role</label>
<input type="role" name="role" id="input-role" placeholder="role" autocapitalize="words" autofocus>
</div>
      <p>
      <button   id="button-ajouter" class="btn">Ajouter</button>
