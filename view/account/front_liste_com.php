...
<td>
        <a class="Excel" href="excel_front_c.php">EXCEL</a>
        <a class="Pdf" href="pdf_front_c.php">PDF</a>
        </td>
        <div class="content">
		...
		<table  border=1 align = 'center' id=tab_commande >
			...
			?>
				<tr>
					...
					<td>
					<a href="supprim_com.php?id=<?PHP echo $commande['code_commande'];?>">Supprimer</a>
                    <a class="modidfier" href="modif_com.php?id_modif=<?PHP echo $commande['code_commande'];?>">Modifier</a>
					</td>	
				</tr>
			<?PHP
				}
