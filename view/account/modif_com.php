...
?>
<form class="form-box" id="create_customer" method="POST" action="validmodifier_com.php" enctype="multipart/form-data">
...
<div  data-errormsg="">
    <input type="text" name="nom_commande" id="nom_commande" value="<?php echo $row['nom_commande']; ?>"  tabindex="2" />
</div>
<div  data-errormsg="">
    <input type="int" name="prix" id="prix" value="<?php echo $row['prix']; ?>"  tabindex="3" />
</div>
<div  data-errormsg="">
    <input type="text" name="etat" id="etat" value="<?php echo $row['etat']; ?>"  tabindex="4" />
</div>
