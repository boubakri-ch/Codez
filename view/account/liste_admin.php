...
<a class="supprimer" href="pdf_admin.php">PDF</a>
<a class="supprimer" href="excel.php">EXCEL</a>
<div class="content">
        <form enctype="multipart/form-data">
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    <input class="form-control mr-sm-2" type="text" placeholder="Search" name="search" id="bbbb">
</nav>
<style>
table {
        ...
        <th>Role</th>
			...
			?>
				<tr>
					...
					<td>
					 <a class="supprimer" href="supprim_admin.php?id=<?PHP echo $admin['code_admin'];?>">Supprimer</a>
					 <a class="modifier" href="modif_admin.php?id_modif=<?PHP echo $admin['code_admin'];?>">Modifier</a>
					</td>	
				</tr>
