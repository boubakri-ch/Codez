...
const reset_prod=function(ev)
{
    ...
    document.getElementById('customer_login').reset();
...
const validate = function(ev){
    ...
    let password_a=document.getElementById('input-password');
    let role_a=document.getElementById('input-role');
    ...
    {  
        ...
        failures.push({input:'input-role', msg:'Champs requis'})
    }
