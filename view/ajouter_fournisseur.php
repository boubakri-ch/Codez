...
<body>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                            <li><i class="fa fa-puzzle-piece"></i><a href="ajouter_articles.php">ajouter un article</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-fort-awesome"></i><a href="afficher_reservation.php">liste des réservation</a></li>
                        </ul>
                    </li>
                    <li>
    ...
    <div id="right-panel" class="right-panel">
      ...
      <div  data-errormsg="">
            <input type="text" name="numero" id="input-numero" autofocus placeholder="numero" tabindex="2" />
        </div>
