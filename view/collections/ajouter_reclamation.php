 ...
 if (isset($_POST['reclamation']))
{
  ...
  $r=new reclamation(null,$_POST['reclamation'],$_SESSION['unique_id']);


    $res = new reclamationOps();
    $res->ajouterReclamation($r);
...
<form class="form-box" id="form-rec" method="POST" action="" enctype="multipart/form-data">
                                    <h1>Réclamation </h1>
                                    <div  data-errormsg="">
            <textarea name="reclamation" id="input-libelle" rows=8 cols=80 tabindex="3" > </textarea>
                           </div>
...
const send = function(ev){
   ...
   if(fails.length === 0){
       //good to go
       document.getElementById('form-rec').submit();
   }else{
...
const validate = function(ev){
   ...
   let nom=document.getElementById('input-libelle');
   ...
   if(nom.value==="")
   {
        ...
        alert("vous devez saisir votre reclamation")
   }
