...
$liste_menu=$menu->afficher_reclamation($start,$perpage,$_SESSION['unique_id']);
...
<div class="grid__item">        
  ...
  <div class="toolbar">
    ...
    <table class="table" border=1 align = 'center'  >
        ...
        ?>
            <tr>
                <td width="200"><?PHP echo $menu['descrip']; ?></td>
                
             	
           
            <td>
					 <a class="supprimer" href="../supprimer_rec.php?id=<?PHP echo $menu['code_rec'];?>">Supprimer</a>
           <a class="Modifeir" href="modif_rec.php?id=<?PHP echo $menu['code_rec'];?>">Modifier</a>
