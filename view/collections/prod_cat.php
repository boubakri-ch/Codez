...
$libelle_categorie=$_GET['libelle'];
$produit=new produitOps();
$liste_produit=$produit->afficher_produit_cat($libelle_categorie);	
        ...
        <li class="customer_account"> 
          <div class="header-account_links">
            <ul> 
              ...
              <li>
                <a href="../logout.php" title="Log in" data-value="value 1"><i class="fa fa-user post-large--hide large--hide medium-down--hide"></i><span class="wide--hide">Log out</span></a>
              </li>
