...
?>
        ...
        <div  data-errormsg="">
                                        <input type="text" name="id" id="input-id" value="<?php echo $row['id']; ?>" autofocus placeholder="id" tabindex="1" />
                                    </div>
                                     <div  data-errormsg="">
                                    ...
                                    <div  data-errormsg="">
                                        <input type="date" name="date" id="input-date" value="<?php echo date ('Y/m/d',strtotime($row['date_l'])); ?> "autofocus placeholder="date" tabindex="5" />
