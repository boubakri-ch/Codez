...
<style type="text/css">
  ...
  .progress {
    ...
    transition: width 0.7s ease;
        ...
        <form method="post" action="https://yummi-theme.myshopify.com/cart/add" id="AddToCartForm" accept-charset="UTF-8" class="product-form" enctype="multipart/form-data"><input type="hidden" name="form_type" value="product" /><input type="hidden" name="utf8" value="✓" />
...
<div class="swatch" data-option-index="0">
    <div class="header">
  	...
  	<div class="variant-options">
        ...
        <div data-value="Non-Veg" class="swatch-element non-veg available">
            

            <input  id="swatch-0-non-veg" type="radio" name="option-0" value="Non-Veg" checked/>

            
            <label for="swatch-0-non-veg">
                Non-Veg
            </label>
        ...
        <input class="text" data-value="swatch-0-non-veg" type="hidden" data-value-sticky="31491711729687" />
...
<div class="swatch" data-option-index="1">
    <div class="header">
  	...
  	<div class="variant-options">
        ...
        <div data-value="Chines" class="swatch-element chines available">
            

            <input  id="swatch-1-chines" type="radio" name="option-1" value="Chines" checked/>

            
            <label for="swatch-1-chines">
                Chines
            </label>
        ...
        <input class="text" data-value="swatch-1-chines" type="hidden" data-value-sticky="31491711729687" />
...
<div class="swatch" data-option-index="2">
    <div class="header">
  	...
  	<div class="variant-options">
        ...
        <div data-value="Beef" class="swatch-element beef available">
            

            <input  id="swatch-2-beef" type="radio" name="option-2" value="Beef" checked/>

            
            <label for="swatch-2-beef">
                Beef
            </label>
        ...
        <input class="text" data-value="swatch-2-beef" type="hidden" data-value-sticky="31491711729687" />
          ...
          <select name="id" id="productSelect" class="product-single__variants" >
            ...
            <option  selected="selected"  value="31491711729687">Non-Veg / Chines / Beef</option>
...
<div class="show">
  <div class="default-wishbutton-beef-steaks loading"><a title="Add to wishlist" class="add-in-wishlist-js btn" href="beef-steaks.html"><i class="far fa-heart"></i><span class="tooltip-label">Add to wishlist</span></a></div>
 <div class="loadding-wishbutton-beef-steaks loading" style="display: none; pointer-events: none"><a class="add_to_wishlist" href="beef-steaks.html"><i class="fas fa-spinner"></i></a></div>
  <div class="added-wishbutton-beef-steaks loading" style="display: none;"><a title="View Wishlist" class="added-wishlist add_to_wishlist btn" href="../pages/wishlist.html"><i class="fas fa-heart"></i><span class="tooltip-label">View Wishlist</span></a></div>
</div>
 </div>
