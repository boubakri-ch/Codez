            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children active dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">  <i class="menu-icon fa fa-cogs"></i> Articles</a>
...
$p = new reclamationOps();
$liste = $p->selectclient($_GET['id_modif']);


foreach($liste as $row){
?>
<form class="form-box" id="form-reclamation" method="POST" action="validmodif_rec.php" enctype="multipart/form-data">
<h1>Modifier une réclamation</h1>

<div  data-errormsg="">
    <input type="text" name="id_reclamation" id="input-id" value="<?php echo $row['code_rec']; ?>" readonly tabindex="1" />
</div>
<div  data-errormsg="">
    <input type="text" name="descrip" id="input-descrip" value="<?php echo $row['descrip']; ?>"  tabindex="2" />
</div>
