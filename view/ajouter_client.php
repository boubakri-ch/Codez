<?php   
    ...
    $p=new client (null,$_POST['nom'],$_POST['prenom'],$_POST['email'],$_POST['password']);

    
        $client = new clientOps();
        $client->ajouterClient($p);
...
<body>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                            <li><i class="fa fa-puzzle-piece"></i><a href="ajouter_admin.php">Ajouter un admin</a></li>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
        <form class="form-box" id="form-client" method="POST" action="">
