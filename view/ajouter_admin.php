...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div  data-errormsg="">
            <input type="text" name="email" id="input-email" autofocus placeholder="email" tabindex="3" />
        </div>

        <div  data-errormsg="">
            <input type="text" name="password" id="input-password" autofocus placeholder="password" tabindex="4" />
        </div>
      
        <div  data-errormsg="">
            <input type="text" name="role" id="input-role" autofocus placeholder="role" tabindex="5" />
        </div>
