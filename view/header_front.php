...
if ($(window).width() < 1200) {
  ...
  <div class="h1 site-header__logo order-header  post-large--hide large--hide medium-down--hide" itemscope itemtype="http://schema.org/Organization">
    ...
    <a href="../index.php" itemprop="url">
      <img class="normal-logo" src="../assets/tuni.png" alt="Yummi-theme" itemprop="logo">
    </a>
...
<a class="menu__moblie "  href="../collections/recette.php">
        Recette
    ...
    <li class="menu-lv-1 item dropdown mega-menu">
        ...
        <a class="menu__moblie "  href="../collections/rece.php">
            Recette
            ...
            <li class="customer_account"> 
              <div class="header-account_links">
                <ul> 
                  ...
                  <li>
                    <a href="../account/page_login.php" title="Log in" data-value="value 1"><i class="fa fa-user post-large--hide large--hide medium-down--hide"></i><span class="wide--hide">Log in</span></a>
                  </li>
              ...
              <div class="header-panel-top">
                <div class="customer_account">                          
                  <ul>
                    ...
                    <li>
                      <a href="../account/page_login.php" title="Log in"> <i class="fa fa-sign-in-alt icons" aria-hidden="true"></i> Log in</a>
                    </li>
                    <li>
